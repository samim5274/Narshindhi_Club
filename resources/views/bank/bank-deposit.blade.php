...
<html lang="en">
<head>
    <title>Bank Diposit | {{ $company->name ?? 'Undefined' }}</title>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Bank Diposit</li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card shadow-sm border-0 rounded-3">
                                        <div class="card-header bg-primary text-white fw-bold">
                                            Bank Deposit Details - ৳{{ number_format($dipositDetails->sum('amount'), 2) ?? '0.00' }}/-
                                        </div>
                                                    ...
                                                    <tbody>
                                                        @forelse($dipositDetails as $key => $deposit)
                                                            <tr>
                                                                ...
                                                                <td>৳{{ number_format($deposit->amount, 2) ?? '0.00' }}/-</td>
                                                            </tr>
                                                        @empty
                                                            <tr>
                                                        ...
                                                        <tr class="table-secondary fw-bold">
                                                            ...
                                                            <td colspan="2" class="text-end">৳{{ number_format($dipositDetails->sum('amount'), 2) ?? '0.00' }}/-</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
