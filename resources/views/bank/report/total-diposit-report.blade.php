...
<html lang="en">
<head>
    <title>Total Diposit | {{ $company->name ?? 'Undefined' }}</title>
           ...
           @include('layouts.message')
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Total Diposit Report</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('/filter-total-diposit-date') }}" method="GET" class="row g-3">
                                @csrf
