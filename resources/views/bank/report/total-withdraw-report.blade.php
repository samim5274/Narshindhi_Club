...
<html lang="en">
<head>
    <title>Total Withdraw | {{ $company->name ?? 'Undefined' }}</title>
           ...
           @include('layouts.message')
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Total Withdraw Report</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('/filter-total-Withdraw-date') }}" method="GET" class="row g-3">
                                @csrf
                                ...
                                <div class="col-lg-12">
                                    <label for="bank_name" class="form-label">Bank Account <span class="text-danger">*</span></label>
                                            ...
                                            <div class="card-body p-0">
                                                <div style="max-height: 500px; overflow-y: auto;">
                                                    <table class="table table-hover table-striped mb-0">
                                                        ...
                                                        <tbody>
                                                            @forelse($withdrawDetails as $key => $deposit)
                                                                <tr>
                                                                    <td>{{ $key + 1 }}</td>
