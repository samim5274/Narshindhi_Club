           ...
           @include('layouts.message')
            ...
            <div class="table-responsive">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5> <small><a href="{{ url()->previous() }}"><i class="fa-solid fa-angles-left"></i>Go Back</a></small> Category wise Expenses Report</h5>
                </div>
                        ...
                        <thead class="table-dark">
                           <tr class="table-light">
                                <th colspan="6" class="text-center">
                                    <form action="{{ url('/filter-expenses-category') }}" method="GET" class="d-flex justify-content-center align-items-center gap-2">
