...
<html lang="en">
<head>
    <title>Extra Income | {{ $company->name ?? 'Undefined' }}</title>
            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="row align-items-center">
                        <h2>Expeses Details - <small>Total Expenses: {{ $incomes->sum('amount') }}/-</small></h2>
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <div class="col-lg-8">
                                    <form action="{{ url('/create-income') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control" placeholder="Enter expense title" required>
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <textarea name="description" id="description" class="form-control" rows="4" placeholder="Enter expense details">N/A</textarea>
                                        </div>
                                        ...
                                        <div class="row g-3 mt-3 mb-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="number" step="0.01" name="amount" id="amount" class="form-control" min="1" placeholder="Enter amount" required>
                                            </div>
                                        </div>
                                        ...
                                        <!-- Submit Button -->
                                        <div class="d-grid">
                                            <button type="submit" class="btn btn-success btn-md d-flex align-items-center justify-content-center gap-2" onclick="return confirm('Are you sure you want save this Income?')">
                                                        ...
                                                        <td>
                                                            <div class="d-flex flex-column gap-2 p-3 border rounded shadow-sm">
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-center mt-1">                                                                    
                                                                    ...
                                                                    <div>
                                                                        <a href="{{ url('/print-income-invoice/'.$val->id) }}" target="_blank"><i class="fa-solid fa-print" style="cursor:pointer;"></i></a>
                                                                    </div>
                                                                </div>
    ...
    <script>
        $(document).ready(function() {
            $('#category_id').on('change', function() {
                ...
                if(categoryId) {
                    $.ajax({
                        url: '/get-incomesubcategories/' + categoryId,
                        type: 'GET',
                        dataType: 'json',
