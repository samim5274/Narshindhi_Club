...
<html lang="en">
<head>
    <title>Income-Setting | {{ $company->name ?? 'Undefined' }}</title>
            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="row align-items-center">
                        <h2>Income Setting</h2>
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('/')}}">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="{{url('/extra-income')}}">Income</a></li>
                                <li class="breadcrumb-item" aria-current="page">Income-Setting</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">                                
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <form action="{{ url('/create-sub-category-income') }}" method="POST">
                                        @csrf

                                        <!-- Sub Category Name -->
                                        <div class="mb-3">
                                            <label for="name" class="form-label">Sub-Category Name <span class="text-danger">*</span></label>
                                            <input type="text" name="txtName" id="name" class="form-control form-control-lg" placeholder="Enter category name" required>                                            
                                        </div>
