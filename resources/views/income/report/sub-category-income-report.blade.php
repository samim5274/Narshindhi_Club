           ...
           @include('layouts.message')
            ...
            <div class="table-responsive">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5> <small><a href="{{ url()->previous() }}"><i class="fa-solid fa-angles-left"></i>Go Back</a></small> Sub-Category wise Income Report</h5>
                </div>
                        ...
                        <thead class="table-dark">
                           <tr class="table-light">
                                <th colspan="6" class="text-center">
                                    <form action="{{ url('/filter-incomes-sub-category') }}" method="GET" class="d-flex justify-content-center align-items-center gap-2">
                                        ...
                                        <select name="subcategory_id" id="subcategory_id" class="form-control form-control-sm" required>
                            ...
                            @foreach ($incomes as $key => $val)
                                <tr>
                                    ...
                                    <td class="text-center fw-bold text-danger">
                                        ...
                                        <a href="{{ url('/print-income-invoice/'.$val->id) }}" target="_blank">
