           ...
           @include('layouts.message')
            ...
            <div class="table-responsive">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5>Purchases Products Stock In/Out</h5>
                </div>
                ...
                <div class="table-responsive" style="max-height: 750px; overflow-y: auto;">
                    <table class="table table-bordered table-hover align-middle shadow-sm mb-0">
                        ...
                        <tbody id="food_table_body">
                            @foreach ($productsStock as $key => $val)
                                <tr>
                            ...
                            <tr class="table-secondary">
                                <td colspan="2" class="text-center">Total: {{ $productsStock->sum('stockIn') - $productsStock->sum('stockOut') }}</td>
                                <td class="text-center">{{ $productsStock->sum('stockIn') }}</td>
                                <td class="text-center">{{ $productsStock->sum('stockOut') }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
